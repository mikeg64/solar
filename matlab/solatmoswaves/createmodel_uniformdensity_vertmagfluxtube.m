newfilename='3D_128_2p5_2p5_12p5_asc_udvmft.ini'; %udvmft=uniform density vertical magnetic fluxt tube
...
consts.ggg= 0.0;  %-274.0e0 % acceleration due to gravity on the sun
...
tempg=5109.4*ones(1,nx1);
presg=7160.2*ones(1,nx1);
densg=0.0001*ones(1,nx1);
energ=zeros(1,nx1);
...
[simparams, simgridinfo, simdata]=generatefield_verttube_rhouni(simparams, simgridinfo, simdata, 'vertfieldtube');      
