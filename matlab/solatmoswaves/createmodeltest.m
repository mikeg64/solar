  ...
  it=0;
      ...
      adiab=1.0;
       ...
       for i=1:nx1
           for j=1:nx2
               for k=1:nx3
                   xx(i,j,k)=(xmin-ngx1*dx)+(i+4)*dx;
                   rheight(1,i)=(xmin-ngx1*dx)+i*dx;
...
% dens=1e12*dens;
tempg=interp1(height,temp,(xmin-ngx1*dx):dx:(xmax+(ngx1+2)*dx));
presg=interp1(height,pres,(xmin-ngx1*dx):dx:(xmax+(ngx1+2)*dx));
densg=interp1(height,dens,(xmin-ngx1*dx):dx:(xmax+(ngx1+2)*dx));

ninterp=size(tempg);
nint=ninterp(2);

tempg(1,nint)=tempg(1,nint-4);
tempg(1,nint-1)=tempg(1,nint-4);
tempg(1,nint-2)=tempg(1,nint-4);
tempg(1,nint-3)=tempg(1,nint-4);
tempg(1,nint+1)=tempg(1,nint-4);
tempg(1,nint+2)=tempg(1,nint-4);

presg(1,nint)=presg(1,nint-4);
presg(1,nint-1)=presg(1,nint-4);
presg(1,nint-2)=presg(1,nint-4);
presg(1,nint-3)=presg(1,nint-4);
densg(1,nint)=densg(1,nint-4);
densg(1,nint-1)=densg(1,nint-4);
densg(1,nint-2)=densg(1,nint-4);
densg(1,nint-3)=densg(1,nint-4);
densg(1,nint+1)=densg(1,nint-4);
densg(1,nint+2)=densg(1,nint-4);
...
%  enddo
      ...
      for i=1:nx1
           for j=1:nx2
               for k=1:nx3
                   simdata.w(i,j,k,10)=densg(i+4);  %density
