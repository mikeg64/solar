...
Compilation in C (see samples/calc):
    ...
    gcc -o calcserver calcserver.c stdsoap2.c soapC.c soapServer.c /c/MinGW/lib/libws2_32.a

(note additional library for MInGW)

Compilation in C++ (see samples/calc++):
    soapcpp2 -i calc.h
    gcc -o calcclient++ calcclient.cpp stdsoap2.cpp soapC.cpp soapcalcProxy.cpp
